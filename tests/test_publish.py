...
@pytest.mark.parametrize("url", [
    "https://github.com/traveller/tickets-bot.git",
    "https://github.com/traveller/tickets-bot",
    "git@github.com:traveller/tickets-bot.git",
    "ssh://git@github.com/traveller/tickets-bot.git",
])
def test_the_repository_is_read_out_of_the_remote_url(url, monkeypatch):
    ...
    assert publish._target() == ("origin", "main", "traveller/tickets-bot")
