...
def airport_frequent() -> dict:
    ...
    order - the airport down the road before the one that costs you a morning,
    because that is the order you would rather leave from. It falls back to counting the airports your saved
