...
basic axis, and it is the one nothing knew: one airport is a tram ride, the next
is a morning, the third is a coach. Frequency cannot discover that, because the
reason a convenient airport goes unused is usually that it has no inventory.
